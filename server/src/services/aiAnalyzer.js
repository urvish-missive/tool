...
function validateReport(report, metrics) {
  ...
  return {
    ...
    geo_citation_score: report.geo_citation_score != null ? clamp(report.geo_citation_score) : null,
    eeat_score: report.eeat_score != null ? clamp(report.eeat_score) : null,
    search_intent: report.search_intent || { type: 'N/A', confidence: 'N/A', explanation: 'No data available.' },
    ai_search_readiness: report.ai_search_readiness || null,
...
function generateFallbackReport(metrics, targetKeyword, contentType) {
  ...
  return {
    ...
    geo_citation_score: null,
    eeat_score: null,
    search_intent: {
      type: 'N/A',
      confidence: 'N/A',
      explanation: 'Intent could not be determined without AI analysis.',
    },
    ai_search_readiness: null,
    eeat_insights: [],
