...
export const keywordResearchSchema = z.object({
  seedKeyword: z.string().trim().min(2, 'Keyword must be at least 2 characters.').max(100).optional().or(z.literal('')),
  ...
  { message: 'Enter a seed keyword or a website URL (at least one is required).', path: ['seedKeyword'] }
)
