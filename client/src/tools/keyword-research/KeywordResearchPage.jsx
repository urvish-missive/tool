            ...
            {filtered.map((k, i) => (
              <tr key={i} className="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td className="py-2.5 pr-4">
                  <span
                    className={`px-2 py-0.5 rounded-full text-xs font-semibold ${INTENT_COLORS[k.intent] || 'bg-gray-100 text-gray-700'}`}
                  >
                    {k.intent}
                  </span>
                </td>
                <td className="py-2.5 pr-4">
                  <div className="flex items-center gap-2">
                    <div className="w-16 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full ${k.opportunityScore >= 80 ? 'bg-green-500' : k.opportunityScore >= 60 ? 'bg-yellow-500' : 'bg-red-400'}`}
                ...
                <td className="py-2.5 pr-4">
                  <span className="text-xs font-bold">{k.businessRelevance}</span>
                </td>
                <td className="py-2.5">
                  <button
      ...
      <section className="relative !pt-36 overflow-hidden py-16 sm:py-20 lg:py-24">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="mt-5 text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Discover keyword ideas, search intent, long-tail opportunities, topic clusters and
            content ideas for your SEO strategy.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          {isError && !isLoading && (
            <div className="bg-white rounded-2xl border border-red-200 shadow-sm p-8 text-center max-w-md mx-auto">
              ...
              <button
                onClick={handleReset}
                className="mt-4 px-6 py-2.5 rounded-lg bg-gray-100 text-sm font-medium text-gray-700 hover:bg-gray-200"
              >
                Try Again
              </button>
            </div>
          ...
          {report && (
            <div id="kr-report" className="space-y-8">
              ...
              <p className="text-xs text-gray-400 text-center">
                Opportunity scores are internal tool estimates, not Google keyword difficulty
                scores. Search volume is not available in this free tool.
              </p>
              ...
              <div className="relative overflow-hidden rounded-2xl p-8 sm:p-12 text-center">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-white">
                    Want to turn these keywords into growth?
                  </h3>
                  <p className="mt-3 text-white/80 max-w-lg mx-auto">
                    Our SEO experts can build a keyword strategy, content roadmap and organic growth
