        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-gray-100">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-bold uppercase tracking-wider mb-1.5">
              ...
              Linkable Asset Blueprint
            </div>
            <h3 className="text-xl font-bold text-gray-900">
              Authority-Building Backlink Angles ({backlinkAngles.length})
            </h3>
            <p className="text-xs sm:text-sm text-gray-500 mt-0.5">
              Assets engineered to naturally attract citations and bypass the competitor's backlink moat.
            </p>
          </div>
        ...
        {backlinkAngles.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {backlinkAngles.map((asset, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-200 hover:border-emerald-300 transition-all flex flex-col justify-between space-y-3 shadow-xs"
              >
                <div className="space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-emerald-50 text-emerald-700 text-[11px] font-bold uppercase tracking-wider border border-emerald-100">
                ...
                <div className="p-3 bg-emerald-50/40 rounded-xl border border-emerald-100 text-xs text-gray-800 space-y-1">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-800 flex items-center gap-1.5">
                    <Users className="w-3 h-3 text-emerald-600" /> Target Outreach Prospects:
                  </span>
