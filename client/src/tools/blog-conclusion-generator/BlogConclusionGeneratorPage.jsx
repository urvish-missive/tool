            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-5 border border-slate-200 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <button
                  ...
                  className="flex-1 sm:flex-none justify-center px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold transition-all flex items-center gap-1.5 cursor-pointer whitespace-nowrap"
                >
                  {copiedAll ? (
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none justify-center px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-lg bg-slate-900 hover:bg-black text-white text-xs font-semibold transition-all flex items-center gap-1.5 shadow-2xs cursor-pointer whitespace-nowrap"
                >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-2.5 text-xs sm:text-sm text-slate-700 leading-relaxed">
                      {item.hookClosure && (
                        <p className="font-semibold text-slate-900 bg-blue-50/50 p-2.5 rounded-xl border border-blue-100 break-words">
                          {item.hookClosure}
                        </p>
                      )}
                      <div className="whitespace-pre-line break-words">{item.body}</div>
                    </div>
                    ...
                    <div className="p-3 sm:p-3.5 rounded-xl bg-gradient-to-r from-blue-50/70 via-slate-50 to-pink-50/40 border border-blue-200 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
                      <div className="space-y-1 min-w-0 flex-1">
                        ...
                        <p className="text-xs text-slate-800 font-medium break-words">{item.ctaPrompt}</p>
                        <div className="inline-block pt-1">
                          <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-[#0C81F3] to-[#EB8988] text-white text-xs font-bold rounded-lg shadow-2xs break-words">
                            {item.ctaButtonText}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-2 border-t border-slate-100">
                      <div className="text-[11px] text-slate-500 italic max-w-xl break-words">
                      ...
                      <button
                        ...
                        className={`w-full sm:w-auto px-3.5 py-2 sm:py-1.5 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition-all cursor-pointer whitespace-nowrap shrink-0 shadow-2xs ${
                          isCopied
