              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {(dataResult.caseStudy?.metrics || []).map((m, idx) => (
                    <div
                      key={idx}
                      className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group hover:border-[#0C81F3] transition-all"
                    >
                ...
                {dataResult.caseStudy?.clientQuote && (
                  <div className="bg-gradient-to-r from-blue-50/80 via-indigo-50/40 to-slate-50 border border-blue-200/80 rounded-2xl p-4 sm:p-6 relative shadow-2xs">
