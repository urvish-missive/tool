        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Content Consultancy</a></li>
          ...
          <div>
            ...
            <div className="space-y-5">
              <div>
                <span className="text-[11px] font-semibold tracking-widest uppercase text-gray-500">Call Us</span>
                <p className="text-white font-semibold text-sm mt-1">+91 95370 95025</p>
              </div>
              <div>
                <span className="text-[11px] font-semibold tracking-widest uppercase text-gray-500">Email Us</span>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                { label: 'Facebook', path: 'M24 12c0-6.627-5.373-12-12-12S0 5.373 0 12c0 5.99 4.388 10.954 10.125 11.854V15.47H7.078V12h3.047V9.356c0-3.007 1.792-4.668 4.533-4.668 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874V12h3.328l-.532 3.47h-2.796v8.385C19.612 22.954 24 17.99 24 12z' },
                ...
                <a key={label} href="#" aria-label={label}
                  ...
                  <svg className="w-4 h-4 fill-current text-gray-400" viewBox="0 0 24 24"><path d={path} /></svg>
                </a>
              ))}
            </div>
          </div>
