...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#171720] border-t border-slate-800/80 text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a
                  href="https://missivedigital.com/seo-agency/"
            ...
            <div className="space-y-4">
              <div>
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#0C81F3] to-[#EB8988] px-4 py-2 text-xs font-bold text-white hover:opacity-95 transition-opacity shadow-sm group"
                >
              ...
              <ul className="space-y-2.5 text-sm pt-1">
                <li>
                  <a
                    href="https://missivedigital.com/about/"
                    className="hover:text-white transition-colors"
                  >
                    About Missive
                  </a>
                ...
                <li>
                  <a
                    href="https://missivedigital.com/case-studies/"
                    className="hover:text-white transition-colors"
                  >
                    Case Studies
                  </a>
                ...
                <li>
                  <a
                    href="https://missivedigital.com/blog/"
                    className="hover:text-white transition-colors"
                  >
                    Official Blog
                  </a>
                ...
                <li>
                  <a
                    href="https://missivedigital.com/contact-us/"
                    className="hover:text-white transition-colors"
                  >
                    Contact Us
                  </a>
              ...
              <div className="pt-2 border-t border-gray-800/80">
                ...
                <p className="text-white font-semibold text-sm mt-0.5">
                  <a href="tel:+919537095025" className="hover:text-[#67A7FF] transition-colors">
                    +91 95370 95025
                  </a>
                </p>
              </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-4 leading-relaxed">
              Follow our organic digital marketing updates and SEO playbooks.
            </p>
            <div className="flex flex-wrap gap-3">
              {[
                {
                  label: 'LinkedIn',
                  href: 'https://www.linkedin.com/company/missivedigital',
                  path: 'M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z',
                },
                {
                  label: 'YouTube',
                  href: 'https://www.youtube.com/@missive.digital',
                  path: 'M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z',
                },
                {
                  label: 'Instagram',
                  href: 'https://www.instagram.com/missive.digital/',
                ...
                {
                  label: 'X (Twitter)',
                  href: 'https://twitter.com/missivedigital',
                  path: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z',
                },
                {
                  label: 'Facebook',
                  href: 'https://www.facebook.com/missivedigital',
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-10 h-10 rounded-full border border-gray-700 bg-white/5 flex items-center justify-center hover:border-white hover:bg-white/10 transition-all text-gray-400 hover:text-white"
                >
        ...
        <div className="mt-12 pt-8 border-t border-gray-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          <div>
            ...
            . Curated & Founded by Himani Kankaria. All rights reserved.
          </div>
          <div className="flex flex-wrap items-center gap-3.5 text-xs">
            <a
              href="https://missivedigital.com/privacy-policy/"
            ...
            <span>•</span>
            <a
              href="https://missivedigital.com/terms-and-conditions/"
              className="hover:text-gray-300 transition-colors"
            >
              Terms & Conditions
            </a>
            ...
            <a
              href="https://calendly.com/missivedigital/30min"
              className="text-[#67A7FF] hover:text-white font-semibold transition-colors flex items-center gap-1"
            >
