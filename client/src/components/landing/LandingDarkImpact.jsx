import { Sparkles, ArrowRight, Zap, Quote, Flame } from 'lucide-react'
import useScrollReveal from './useScrollReveal'

/**
 * LandingDarkImpact — signature dark mode impact section inspired by Missive Digital's #171720 aesthetic.
 */
export default function LandingDarkImpact({ onCtaClick }) {
          ...
          {onCtaClick && (
            <div className="pt-3">
              ...
              >
                ...
                <span>Stop the Bounce — Generate High-Converting Intros</span>
